...
public class StockResourceIntTest {
    ...
    private static final Integer DEFAULT_NB_BOUTEILLE = 1;
    private static final Integer UPDATED_NB_BOUTEILLE = 2;
    ...
    public static Stock createEntity(EntityManager em) {
        Stock stock = new Stock()
            .nbBouteille(DEFAULT_NB_BOUTEILLE);
        return stock;
    }
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.getNbBouteille()).isEqualTo(DEFAULT_NB_BOUTEILLE);
    }
    ...
    public void getAllStocks() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nbBouteille").value(hasItem(DEFAULT_NB_BOUTEILLE)));
    }
    ...
    public void getStock() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks/{id}", stock.getId()))
            ...
            .andExpect(jsonPath("$.nbBouteille").value(DEFAULT_NB_BOUTEILLE));
    }
    ...
    public void updateStock() throws Exception {
        ...
        updatedStock
            .nbBouteille(UPDATED_NB_BOUTEILLE);
        ...
        Stock testStock = stockList.get(stockList.size() - 1);
        assertThat(testStock.getNbBouteille()).isEqualTo(UPDATED_NB_BOUTEILLE);
    }
